 ...
 * </ul>
 * @version   1.1.1
 * @revision  $Id: Ext.ux.grid.Search.js 542 2009-02-06 11:37:16Z jozo $
 *
...
Ext.extend(Ext.ux.grid.Search, Ext.util.Observable, {
	...
	/**
	 * @cfg {Boolean} showMenuButton Menu Button item is shown in menu if true (defaults to true)
	 */
	,showMenuButton:true
