...
Ext.ux.form.LoginDialog = function (config) {
    ...
    var css = '.ux-auth-header-icon {background: url("' + this.basePath + '/small/locked.png") 0 4px no-repeat !important;}'
        ...
        + '.ux-auth-login {background-image: url("' + this.basePath + '/medium/button_ok.png") !important;}'
        + '.ux-auth-close {background-image: url("' + this.basePath + '/medium/cancel.png") !important;}'
        + '.ux-auth-forgot {background-image: url("' + this.basePath + '/medium/search.png") !important;}'
    ...
    this._formPanel = new Ext.form.FormPanel ({
        ...
        items : [{
        	...
        	xtype: 'anexia_countrycombobox',
            hiddenName: this.languageField,
            fieldLabel: this.languageLabel,
			triggerAction: 'all',
			mode: 'remote',
			readOnly: true,
			fields: ['countryid','country_name','alpha2'],
			displayField: 'country_name',
			valueField: 'alpha2',
			allowBlank: false,
			store: new Ext.data.JsonStore({
				url: this.Controller.Url + '/login/languages',
				totalProperty: 'count',
				root: 'records',
				fields:['countryid','country_name','alpha2']        
			}),
        	...
        	IconFolder: '/assets/images/flags/'
        }, {
            xtype       : 'checkbox',
...
Ext.extend (Ext.ux.form.LoginDialog, Ext.util.Observable, {
    ...
    languageChanged : function (formField, newValue, oldValue) {
    	this.fireEvent('languagechanged', this, newValue);
    }
