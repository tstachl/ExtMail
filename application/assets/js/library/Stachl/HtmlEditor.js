Ext.ns('Stachl.form');
Stachl.form.HtmlEditor = Ext.extend(Ext.form.Field, {
    ...
    onDisable: function(){
        this.wrap.mask();
        Stachl.form.HtmlEditor.superclass.onDisable.call(this);
    },

    onEnable: function(){
        this.wrap.unmask();
        Stachl.form.HtmlEditor.superclass.onEnable.call(this);
    },

    setReadOnly: function(readOnly){

        Stachl.form.HtmlEditor.superclass.setReadOnly.call(this, readOnly);
        if(this.initialized){
            if(Ext.isIE){
    ...
    onRender : function(ct, position){
        Stachl.form.HtmlEditor.superclass.onRender.call(this, ct, position);
    ...
    afterRender: function() {
        Stachl.form.HtmlEditor.superclass.afterRender.call(this);
        if(!this.width){
    ...
    onResize : function(w, h){
        Stachl.form.HtmlEditor.superclass.onResize.apply(this, arguments);
    ...
    setValue : function(v){
        Stachl.form.HtmlEditor.superclass.setValue.call(this, v);
        this.pushValue();
        return this;
    },
    ...
    getValue : function() {
        ...
        return Stachl.form.HtmlEditor.superclass.getValue.call(this);
    },
...
Ext.reg('stachl_htmleditor', Stachl.form.HtmlEditor);
